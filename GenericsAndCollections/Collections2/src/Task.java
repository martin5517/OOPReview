public class Task {
    public static void main(String[] args){
      ...
      /* TODO
Create a counter of String objects called words., and make it work for the words in the String text above. That way, the rest will compile. */Counter<String> words = new Counter<>(text.split(" "));
